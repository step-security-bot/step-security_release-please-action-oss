...
1. Create a `.github/workflows/release-please.yml` file with these contents:
   ...
   jobs:
     release-please:
       ...
       steps:
         - uses: step-security/release-please-action-oss@v6
           with:
    ...
    steps:
      ...
      - name: tag major and minor versions
        ...
        run: |
          ...
          git remote add gh-token "https://${{ secrets.GITHUB_TOKEN }}@github.com/step-security/release-please-action-oss.git"
